...
const ForgotPassword = () => {
    ...
    const handleEmailSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Call backend to check email and send OTP
            ...
            if (!result.success) {
                ...
                toast({
                    ...
                    description: result.error || 'No account exists with this email address',
                    variant: 'destructive',
                });
                setLoading(false);
                return;
            ...
            // NOTE: OTP is NOT sent in API response for security
            // User must retrieve OTP from their email
            // We don't store it locally - verification happens on backend
